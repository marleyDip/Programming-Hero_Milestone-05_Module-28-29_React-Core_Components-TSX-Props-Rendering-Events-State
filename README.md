...
![Modules](https://img.shields.io/badge/Modules-27--28-blue?style=flat-square)
![Topics](https://img.shields.io/badge/Topics-17+-purple?style=flat-square)
![Focus](https://img.shields.io/badge/Focus-React%20%2B%20TypeScript-orange?style=flat-square)
...
- [x] Understand React fundamentals
- [x] Build reusable components
- [x] Work with JSX / TSX
- [x] Use TypeScript with React
- [x] Pass and type props
- [x] Implement conditional rendering
- [x] Render dynamic lists
- [x] Handle React events
